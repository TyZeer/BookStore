package com.prt.bookstore.auth.security.jwt;

import com.project.auth.security.services.UserDetailsImpl;
...
public class JwtUtils {
  ...
  @Value("${project.manager.jwtSecret}")
  private String jwtSecret;

  @Value("${project.manager.jwtExpirationMs}")
